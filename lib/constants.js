...
ci[0x03] = "General Purpose Memeory Command";
ci.IO_SAMPLE = 0x04;
ci[0x04] = "I/O Sample";
ci.DATA_ACK = 0x80;
...
//serial
dc.MASK[exports.MODULE_ID.SERIAL_ANY] = {};
dc.MASK[exports.MODULE_ID.SERIAL_ANY][0]  = ["DIO0", "AD0"];
dc.MASK[exports.MODULE_ID.SERIAL_ANY][1]  = ["DIO1", "AD1"];
dc.MASK[exports.MODULE_ID.SERIAL_ANY][2]  = ["DIO2", "AD2"];
dc.MASK[exports.MODULE_ID.SERIAL_ANY][3]  = ["DIO3", "AD3"];
dc.MASK[exports.MODULE_ID.SERIAL_ANY][4]  = ["DIO4"];
dc.MASK[exports.MODULE_ID.SERIAL_ANY][5]  = ["DIO5", "ASSOCIATE"];
dc.MASK[exports.MODULE_ID.SERIAL_ANY][6]  = ["DIO6", "RTS"];
dc.MASK[exports.MODULE_ID.SERIAL_ANY][7]  = ["DIO7", "CTS"];
dc.MASK[exports.MODULE_ID.SERIAL_ANY][10] = ["DIO10", "RSSI"];
dc.MASK[exports.MODULE_ID.SERIAL_ANY][11] = ["DIO11", "PWM"];
dc.MASK[exports.MODULE_ID.SERIAL_ANY][12] = ["DIO12", "CD"];
//wifi
dc.MASK[exports.MODULE_ID.WIFI] = {};
dc.MASK[exports.MODULE_ID.WIFI][0]  = ["DIO0", "AD0"];
dc.MASK[exports.MODULE_ID.WIFI][1]  = ["DIO1", "AD1"];
dc.MASK[exports.MODULE_ID.WIFI][2]  = ["DIO2", "AD2"];
dc.MASK[exports.MODULE_ID.WIFI][3]  = ["DIO3", "AD3"];
dc.MASK[exports.MODULE_ID.WIFI][4]  = ["DIO4", "AD4"];
dc.MASK[exports.MODULE_ID.WIFI][5]  = ["DIO5", "ASSOCIATE"];
dc.MASK[exports.MODULE_ID.WIFI][6]  = ["DIO6", "RTS"];
dc.MASK[exports.MODULE_ID.WIFI][7]  = ["DIO7", "CTS"];
dc.MASK[exports.MODULE_ID.WIFI][8]  = ["DIO8", "DTR"];
dc.MASK[exports.MODULE_ID.WIFI][9]  = ["DIO9", "OnSleep"];
dc.MASK[exports.MODULE_ID.WIFI][10] = ["DIO10", "PWM0"];
dc.MASK[exports.MODULE_ID.WIFI][11] = ["DIO11", "PWM1"];
dc.MASK[exports.MODULE_ID.WIFI][12] = ["DIO12", "SPIMISO"];
dc.MASK[exports.MODULE_ID.WIFI][13] = ["DIO13", "DOUT"];
dc.MASK[exports.MODULE_ID.WIFI][14] = ["DIO14", "DIN"];
...
//TODO wifi pins, what is this used for?
//
// Analog Channel Mask/Pins
//
// Map mask to name (per module)
ac.MASK[exports.MODULE_ID.SERIAL_ANY] = {};
ac.MASK[exports.MODULE_ID.SERIAL_ANY][0] = ["AD0", "DIO0" ];
ac.MASK[exports.MODULE_ID.SERIAL_ANY][1] = ["AD1", "DIO1" ];
ac.MASK[exports.MODULE_ID.SERIAL_ANY][2] = ["AD2", "DIO2" ];
ac.MASK[exports.MODULE_ID.SERIAL_ANY][3] = ["AD3", "DIO3" ];
ac.MASK[exports.MODULE_ID.SERIAL_ANY][7] = ["SUPPLY"];
//wifi
ac.MASK[exports.MODULE_ID.WIFI] = {};
ac.MASK[exports.MODULE_ID.WIFI][0] = ["AD0", "DIO0" ];
ac.MASK[exports.MODULE_ID.WIFI][1] = ["AD1", "DIO1" ];
ac.MASK[exports.MODULE_ID.WIFI][2] = ["AD2", "DIO2" ];
ac.MASK[exports.MODULE_ID.WIFI][3] = ["AD3", "DIO3" ];
ac.MASK[exports.MODULE_ID.WIFI][4] = ["AD4", "DIO4" ];
ac.MASK[exports.MODULE_ID.WIFI][7] = ["SUPPLY"];
...
//TODO check pin modes for wifi, spi options exist for wifi
// 
// Pin Modes
//
pm.P2 = pm.P1 = {
